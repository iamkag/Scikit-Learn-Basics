...
data_train, data_test, output_train, output_test = train_test_split(data, output, test_size=565893, random_state=42, shuffle=False)
...
classifier = LogisticRegression(max_iter=10000, penalty='l2', tol=1e-3, C=1, verbose=1, solver='saga',multi_class="auto")
